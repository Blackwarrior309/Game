...
- **Phase 3** — Volle Götter-Implementierung: Avatar-Spawn-System steht, **Zeus voll** (Blitzeinschlag I1, Donnersturm I2, Kettenblitz-Avatar). Athena/Ares/Poseidon/Hades brauchen noch Interventionen + Avatar-KI. Tempel-Upgrade-Stufen 1–3 fehlen.
